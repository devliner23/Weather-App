      ...
      >
        <div className="max-w-1000px max-h-600px">
          ...
          <div className="text-center p-2">
            <h2 className=" bg-black opacity-50 text-white">{formattedCity}</h2>
            <p className=" bg-black opacity-50 text-white">Temperature: {weatherData.temperature}°F</p>
            ...
            <p className=" bg-black opacity-50 text-white">Humidity: {weatherData.humidity}%</p>
            <p className=" bg-black opacity-50 text-white">Precipitation: {weatherData.precipitation}</p>
          </div>
        </div>
      </div>
    </div>
